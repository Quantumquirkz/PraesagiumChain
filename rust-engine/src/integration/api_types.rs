//! Tipos de API para integración con backend y contratos.

use serde::{Deserialize, Serialize};

/// Resultado de una predicción (salida del motor PHPE).
...
/// Payload para envío on-chain (probabilidad en basis points).
#[derive(Clone, Debug, Serialize, Deserialize)]
