//! Cabeza bayesiana mejorada: ensemble con dropout simulado y mejor estimación de incertidumbre.

use ndarray::Array1;
use rand::{Rng, SeedableRng};
use rand::rngs::StdRng;

/// Parámetros de la cabeza bayesiana mejorada.
#[derive(Clone, Debug)]
...
impl BayesianParams {
    ...
    /// Carga parámetros desde un vector (para modelos entrenados).
...
/// Predicción con dropout simulado (para mayor robustez).
