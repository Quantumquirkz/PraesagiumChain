/**
 * Shared CRE sentiment fetch: POST /api/ai/sentiment (used by public and confidential workflows).
 * Config schemas stay in each workflow's main.ts for Runner/zod compatibility.
 */
...
/**
 * Calls backend sentiment API and maps probability to binary outcome {0,1}.
 */
